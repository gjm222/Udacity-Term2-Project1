...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (!is_initialized_) {
    ...
    */
	...
	previous_timestamp_ = measurement_pack.timestamp_; //Initialize timestamp
  ...
  if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
    ...
    ekf_.H_ = Hj_; //Set to Jacobian becausue this is radar data
	ekf_.R_ = R_radar_;
    ekf_.UpdateEKF(measurement_pack.raw_measurements_); //Radar
	
  } else {
    // Laser updates
    ekf_.H_ = H_laser_;  //Normal H matrix for laser data
	ekf_.R_ = R_laser_;
	ekf_.Update(measurement_pack.raw_measurements_);  //Lidar
  }
